    ...
    <div className="flex w-full flex-col items-center justify-start px-6 md:h-full">
      ...
      {!user && (
        <Link to="/login" prefetch="intent">
          <button className="flex min-h-[40px] flex-row items-center justify-center rounded-xl bg-violet-500 px-6  font-bold text-gray-100 transition hover:scale-105 active:brightness-90">
            Get Started
          </button>
        </Link>
      )}
